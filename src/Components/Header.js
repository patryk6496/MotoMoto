  ...
  return (
    ...
    <div className="w-9/12 h-50 rounded-lg bg-black flex justify-between ">
      <div className="w-1/4 text-white m-2.5 " ><img src={volvoImage} alt='carImage'/></div>
        ...
        <div className = "text-white w-56 flex float-right py-2.5 " ><button className='flex pr-2.5'><img className='w-7 h-9' src={serce} alt='heartIcon'/></button><p className='text-3xl py-0.5'>25000 PLN</p></div>
