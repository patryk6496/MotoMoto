          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="-space-y-px rounded-md ">
              <div className=''>
                ...
                <select className="relative block w-full rounded-lg border-0 py-3  text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" id="marka" name="marka" >
